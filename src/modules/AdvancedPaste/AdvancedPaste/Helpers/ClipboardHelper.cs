...
namespace AdvancedPaste.Helpers
{
    internal static class ClipboardHelper
    {
        ...
        internal static async Task<RandomAccessStreamReference> GetClipboardBitmapContent(DataPackageView clipboardData)
        {
            return await clipboardData.GetBitmapAsync();
        }
    }
}
